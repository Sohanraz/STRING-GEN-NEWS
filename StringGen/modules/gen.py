...
async def gen_session(
    ...
    try:
        ...
        if telethon:
            ...
            await client(JoinChannelRequest("@purohit_Bots"))
        else:
            ...
            await client.join_chat("@purohit_Bots")
    except KeyError:
        pass
    try:
