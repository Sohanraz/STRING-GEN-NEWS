...
MONGO_DB_URI = getenv("MONGO_DB_URI", "mongodb+srv://Sohanrazz:<password>@cluster0.wbcmn82.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")

OWNER_ID = int(getenv("OWNER_ID", "5897793065"))
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/purohit_Bots_Support")
